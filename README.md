...
[![Coveralls](https://img.shields.io/coveralls/Luke-Draper/guild-wars-two-data-analyzer.svg)](https://coveralls.io/github/Luke-Draper/guild-wars-two-data-analyzer)
[![Dev Dependencies](https://david-dm.org/Luke-Draper/guild-wars-two-data-analyzer/dev-status.svg)](https://david-dm.org/Luke-Draper/guild-wars-two-data-analyzer?type=dev)
[![Donate](https://img.shields.io/badge/donate-paypal-blue.svg)](https://paypal.me/AJoverMorales)

### Usage

```bash
git clone https://github.com/Luke-Draper/guild-wars-two-data-analyzer.git YOURFOLDERNAME
cd YOURFOLDERNAME
